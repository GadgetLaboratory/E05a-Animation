...
import arcade
# Set the window resolution that the program will take place in
SCREEN_WIDTH = 640
SCREEN_HEIGHT = 480
SCREEN_TITLE = "Move Mouse Example (hi mom)"
...
# Now, we define the function that runs the game, our main:
def main():
